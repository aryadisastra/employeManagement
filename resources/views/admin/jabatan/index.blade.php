        ...
        <div class="card-body">
            ...
            <div class="card">
                <div class="table-responsive">
                    <table class="jabatan-table table">
...
<div class="modal modal-slide-in new-user-modal fade" id="modals-slide-in">
    <div class="modal-dialog">
        <form class="add-new-user modal-content pt-0" action="/jabatan/store" method="POST" enctype="multipart/form-data">
            @csrf
...
@foreach ( $data as $dt )
    <div class="modal modal-slide-in new-user-modal fade" id="modal-edit-{{ $dt->id }}">
        <div class="modal-dialog">
            <form class="add-new-user modal-content pt-0" action="/jabatan/update/{{$dt->id}}" method="POST" enctype="multipart/form-data">
                @csrf
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>
                <div class="modal-header mb-1">
                ...
                <div class="modal-body flex-grow-1">
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control dt-full-name" id="nama"
                            placeholder="Masukan Nama Jabatan" name="nama" value="{{$dt->nama}}"/>
                    </div>
                    <button type="submit" class="btn btn-primary me-1 data-submit">Simpan</button>
                    <button type="reset" class="btn btn-outline-secondary"
                        data-bs-dismiss="modal">Kembali</button>
