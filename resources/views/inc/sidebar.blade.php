<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    <li class="{{ \str_starts_with(request()->path(), 'employee') ? 'active' : '' }} nav-item"><a href="{{ route('employee') }}"><i data-feather="user-plus" class="avatar-icon"></i><span class="menu-title">Employee</span></a></li>
